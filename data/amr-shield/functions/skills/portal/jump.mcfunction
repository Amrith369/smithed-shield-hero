...
execute at @s[tag=amr.shield.warp.a] run teleport @a[tag=amr.shield.party] ~ ~ ~
...
execute at @s[tag=amr.shield.warp.b] run teleport @a[tag=amr.shield.party] ~ ~ ~
...
execute at @s[tag=amr.shield.warp.c] run teleport @a[tag=amr.shield.party] ~ ~ ~
