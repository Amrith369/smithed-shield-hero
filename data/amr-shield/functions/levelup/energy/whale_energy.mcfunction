scoreboard players set @s[scores={amr.shield.hud.take.energy=1..,amr.shield.whaleprof=0}] amr.shield.hud.take.energy 0
scoreboard players set @s[scores={amr.shield.hud.give.energy=1..,amr.shield.whaleprof=100}] amr.shield.hud.give.energy 0
#################################### MOVE POINTS ##################################################
...
scoreboard players remove @s[scores={amr.shield.hud.take.energy=1..}] amr.shield.whaleprof 1
scoreboard players add @s[scores={amr.shield.hud.take.energy=1..}] amr.shield.energy.points 20
scoreboard players add @s[scores={amr.shield.hud.give.energy=1..}] amr.shield.whaleprof 1
