scoreboard players add @s amr.shield.ltm.rarity 0
execute as @a[scores={amr.shield.ltm.rarity=4..,amr.shield.hud.increase.rarity=1..}] run tellraw @s {"text":"<Rarity Up> Maximum Item Rarity Achieved.","bold":true,"color":"#37D7D7","hoverEvent":{"action":"show_text","contents":[{"text":"Chance Too Low For Success","italic":true,"color":"dark_purple"}]}}
...
execute as @s if score amr.shield.rarenumber amr.shield.raritysuccess matches 1 run scoreboard players add @s amr.shield.ltm.rarity 1
execute as @s if score amr.shield.rarenumber amr.shield.raritysuccess matches 0 run scoreboard players add @s amr.change.shield.ltm 1
...
execute as @s if score amr.shield.rarenumber amr.shield.raritysuccess matches 0 run scoreboard players set @s amr.shield.ltm.rarity 0
#================================================================================================================
