scoreboard players add @s amr.shield.pipe.smelt 0
execute as @a[scores={amr.shield.pipe.smelt=999..,amr.shield.smelt=1..}] run tellraw @s {"text":"<Smelt> Maximum Item Smelt Achieved.","bold":true,"color":"#37D7D7","hoverEvent":{"action":"show_text","contents":[{"text":"Chance Too Low For Success","italic":true,"color":"dark_purple"}]}}
...
execute as @s if score amr.shield.smeltnumber amr.shield.smeltsuccess matches 1 run scoreboard players add @s amr.shield.pipe.smelt 1
execute as @s if score amr.shield.smeltnumber amr.shield.smeltsuccess matches 0 run scoreboard players add @s amr.change.shield.pipe 1
...
execute as @s if score amr.shield.smeltnumber amr.shield.smeltsuccess matches 0 run scoreboard players set @s amr.shield.pipe.smelt 0
#================================================================================================================
