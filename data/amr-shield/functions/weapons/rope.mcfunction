execute as @a[tag=amr.shield,scores={amr.change.shield.rope=1..}] run clear @s shield{ctc:{traits:{"shield_hero":1b}}}
...
execute as @a[tag=amr.shield,scores={amr.change.shield.rope=1..}] run give @s minecraft:shield{display:{Name:'{"text":"Rope Shield 0/10 C","color":"gold","bold":true}',Lore:['{"text":"-Abilities Locked-"}','{"text":"Equip Bonus:","italic":true}','{"text":"Skill: Air Strike Shield"}']},Unbreakable:1b,CustomModelData:369004,ctc:{id:"amr-shield:rope_shield",traits:{"tool/weapon":1b,"shield_hero":1b}},AttributeModifiers:[{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:1,Operation:0,UUID:[I;1292209216,625492818,-1149681624,283251881],Slot:"mainhand"},{AttributeName:"generic.max_health",Name:"generic.max_health",Amount:2,Operation:0,UUID:[I;-119679978,825509608,-1809598732,-1606085347],Slot:"mainhand"}]} 1
