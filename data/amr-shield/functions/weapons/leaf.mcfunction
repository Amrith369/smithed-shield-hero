execute as @a[tag=amr.shield,scores={amr.change.shield.leaf=1..}] run clear @s shield{smithed:{dict:{item:{shield_hero:1b}}}}
...
execute as @a[tag=amr.shield,scores={amr.change.shield.leaf=1..}] run give @s shield{display:{Name:'{"text":"Leaf Shield 0/10","color":"gold","bold":true}',Lore:['{"text":"-Abilities Locked-"}','{"text":"Equip Bonus:","italic":true}','{"text":"absorption ability 1"}']},Unbreakable:1b,CustomModelData:369002,smithed:{id:leaf_shield,dict:{item:{weapon:1b,shield_hero:1b}}},AttributeModifiers:[{AttributeName:"generic.luck",Name:"generic.luck",Amount:1,Operation:0,UUID:[I;1298267987,148783896,-1833955148,923592640],Slot:"mainhand"},{AttributeName:"generic.max_health",Name:"generic.max_health",Amount:4,Operation:0,UUID:[I;1429807571,-880522629,-2055383371,771853637],Slot:"mainhand"}]} 1
...
execute as @a[tag=amr.shield,scores={amr.change.shield.leaf=1..}] run item modify entity @s weapon.mainhand amr-shield:small/pack
